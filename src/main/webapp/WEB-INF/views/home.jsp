	...
	<div class="container">
		...
		<div class="form-card">
			...
			<form action="${pageContext.request.contextPath}/reserve"
				...
				</select> <label>증상</label>
				<textarea name="symptom" required></textarea>

				<label>예약일자</label> <input type="date" name="date" min="${today}"
